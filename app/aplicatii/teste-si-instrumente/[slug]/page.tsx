...
const toolTitles: Record<ToolSlug, string> = {
  "test-ayurveda-dosha": "Test Ayurveda Dosha",
  "respiratie-terapeutica": "Respirație terapeutică",
  "screening-neurologic": "Screening neurologic",
  "revimed-yoga-tibetan": "Revimed Yoga Tibetan",
  "calculator-recuperare-personalizata": "Calculator recuperare personalizată",
